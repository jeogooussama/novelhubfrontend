...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>
        At novelhub, accessible from www.novelhub.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by novelhub
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in novelhub. This policy is not applicable to any
      ...
      <p>
        novelhub follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, novelhub uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of novelhub.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on novelhub, which are sent
        directly to users' browser. They automatically receive your IP address
        when this occurs. These technologies are used to measure the
        effectiveness of their advertising campaigns and/or to personalize the
        advertising content that you see on websites that coyou visit.
      </p>

      <p>
        Note that novelhub has no access to or control over these cookies that
      ...
      <p>
        novelhub's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        novelhub does not knowingly collect any Personal Identifiable
