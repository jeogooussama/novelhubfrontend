  ...
  return (
    <div>
      ...
      <p>
        ...
        of novelhub's Website, located at www.novelhub.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use novelhub if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing novelhub, you agreed to use
        cookies in agreement with the novelhub's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, novelhub and/or its licensors own the
        intellectual property rights for all material on novelhub. All
        intellectual property rights are reserved. You may access this from
        novelhub for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        novelhub does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of novelhub,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, novelhub shall not be liable
      ...
      <p>
        novelhub reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant novelhub a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of novelhub; and (d) the link is
      ...
      <p>
        ...
        e-mail to novelhub. Please include your name, your organization name,
      ...
      <p>
        No use of novelhub's logo or other artwork will be allowed for linking
